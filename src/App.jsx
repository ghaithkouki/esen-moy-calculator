...
function Form() {
    ...
    const addCard = () => {
        ...
        const newCard = {
            type: 'Mix',
            nameMix,
            coefMix: parseFloat(coefMix).toFixed(2), // Updated to parse coefMix as float
            ds1,
            exam,
            otherNote,
    ...
    const addCardCC = () => {
        ...
        const newCard = {
            type: 'CC',
            nameCC,
            coefCC: parseFloat(coefCC).toFixed(2), // Updated to parse coefCC as float
            ds1CC,
            ds2CC,
            otherNoteCC,
            result: moy.toFixed(2)
    ...
    const addCustomCard = () => {
        ...
        const newCard = {
            ...
            name,
            moy,
            coef: parseFloat(coef).toFixed(2), // Updated to parse coef as float
            result
        };
    ...
    return (
      <>
      <h1 className=''>Calculateur de moyenne de l'Esen </h1>
          <div className="container">
              <div className="MatMix">
                  <span><h4>Matiere Mix</h4></span>
              ...
              <div className="Custom">
                  <span><h4>Calculate By Moy  </h4></span>
